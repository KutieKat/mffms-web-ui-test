...
describe('Statistics Charts Functionality', async () => {
   ...
   describe('Dashboard', async () => {
      ...
      it('Should show statistics page when click on `Charts` item', async () => {
         ...
         expect(pageTitle).to.equal('Thống kê tổng quan')
      })
      ...
      it('Should have essential elements for the statistics page', async () => {
